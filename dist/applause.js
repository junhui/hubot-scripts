...
module.exports = function(robot) {
  return robot.hear(/\b(applau(d|se)|bravo|sarcastic applause|(slow|sarcastic) clap)\b/i, function(msg) {
    var type;
    type = /sarcastic/i.test(msg.message.text) ? images.insincere : images.sincere;

...
// Author:
//   sopel
var celebrate, celebrates, greeting, greetings, quote, quotes;

module.exports = function(robot) {
  robot.respond(/(birthday quote)( for )?(.*)/i, function(msg) {
    var name;

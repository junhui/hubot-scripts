...
module.exports = function(robot) {
  return robot.router.post("/hubot/build/", function(req, res) {
    var build, failList, message, soundToPlay, user;
    ...
    return res.end("that tickles:" + process.env.PORT);
  });
};

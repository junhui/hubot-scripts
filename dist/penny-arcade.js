...
module.exports = function(robot) {
  return robot.respond(/pa(\s(0?[1-9]|1[0-2]).(0?[1-9]|[1-2][0-9]|3[0-1]).(19\d{2}|20\d{2}))?$/i, function(msg) {
    var date;
    ...
    return msg.http(`http://penny-arcade.com/comic/${date}`).get()(function(err, res, body) {
